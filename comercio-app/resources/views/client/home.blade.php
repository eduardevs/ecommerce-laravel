                ...
                <div class="container">
                    <div class="row">
                        <div class="slide-text slide_style_center">
                            ...
                            <a href="product-category.php?id=4&type=mid-category" target="_blank" class="btn btn-primary"
                                data-animation="animated fadeInDown">View Women Accessories</a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="slide-text slide_style_center">
                            ...
                            <a href="#" target="_blank" class="btn btn-primary"
                                data-animation="animated fadeInDown">Read More</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="slide-text slide_style_right">
                            ...
                            <p data-animation="animated fadeInRight">Lorem ipsum dolor sit amet, an labores explicari qui,
                                eu nostrum copiosae argumentum has.</p>
                            <a href="#" target="_blank" class="btn btn-primary"
    ...
    <div class="service bg-gray">
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <div class="item">
                        <div class="photo"><img src="{{ asset('frontend/assets/uploads/service-5.png') }}" width="150px"
                                alt="Easy Returns"></div>
                        <h3>Easy Returns</h3>
                        <p>
                ...
                <div class="col-md-4">
                    <div class="item">
                        <div class="photo"><img src="{{ asset('frontend/assets/uploads/service-6.png') }}" width="150px"
                ...
                <div class="col-md-4">
                    <div class="item">
                        <div class="photo"><img src="{{ asset('frontend/assets/uploads/service-7.png') }}" width="150px"
                                alt="Fast Shipping"></div>
                        <h3>Fast Shipping</h3>
                        <p>
                ...
                <div class="col-md-4">
                    <div class="item">
                        <div class="photo"><img src="{{ asset('frontend/assets/uploads/service-8.png') }}" width="150px"
                                alt="Satisfaction Guarantee"></div>
                ...
                <div class="col-md-4">
                    <div class="item">
                        <div class="photo"><img src="{{ asset('frontend/assets/uploads/service-9.png') }}" width="150px"
                                alt="Secure Checkout"></div>
                ...
                <div class="col-md-4">
                    <div class="item">
                        <div class="photo"><img src="{{ asset('frontend/assets/uploads/service-10.png') }}"
                                width="150px" alt="Money Back Guarantee"></div>
                ...
                <div class="col-md-12">
                    <div class="product-carousel">
                        ...
                        <div class="item">
                            <div class="thumb">
                                <div class="photo"
                                    style="background-image:url({{ asset('frontend/assets/uploads/product-featured-95.jpg') }});">
                                </div>
                                <div class="overlay"></div>
                            </div>
                            <div class="text">
                        ...
                        <div class="item">
                            <div class="thumb">
                                <div class="photo"
                                    style="background-image:url({{ asset('frontend/assets/uploads/product-featured-96.jpg') }});">
                                </div>
                                <div class="overlay"></div>
                            </div>
                            <div class="text">
                                <h3><a href="product.php?id=96">Men's Loose Fit Heavyweight Long-Sleeve Pocket T-Shirt</a>
                                </h3>
                                <h4>
                                    $23
                                    <del>
                        ...
                        <div class="item">
                            <div class="thumb">
                                <div class="photo"
                                    style="background-image:url({{ asset('frontend/assets/uploads/product-featured-97.jpg') }});">
                                </div>
                                <div class="overlay"></div>
                            </div>
                            <div class="text">
                                <h3><a href="product.php?id=97">Women's Tea Length Dress with Rosette Detail (Petite &
                                        Regular)</a></h3>
                                <h4>
                                    $67
                                    <del>
                ...
                <div class="col-md-12">
                    <div class="product-carousel">
                        <div class="item">
                            <div class="thumb">
                                <div class="photo"
                                    style="background-image:url({{ asset('frontend/assets/uploads/product-featured-102.jpg') }});">
                                </div>
                                <div class="overlay"></div>
                            </div>
                            <div class="text">
                        ...
                        <div class="item">
                            <div class="thumb">
                                <div class="photo"
                                    style="background-image:url({{ asset('frontend/assets/uploads/product-featured-101.jpg') }});">
                                </div>
                                <div class="overlay"></div>
                            </div>
                            <div class="text">
                        ...
                        <div class="item">
                            <div class="thumb">
                                <div class="photo"
                                    style="background-image:url({{ asset('frontend/assets/uploads/product-featured-100.jpg') }});">
                                </div>
                                <div class="overlay"></div>
                            </div>
                            <div class="text">
                        ...
                        <div class="item">
                            <div class="thumb">
                                <div class="photo"
                                    style="background-image:url({{ asset('frontend/assets/uploads/product-featured-99.jpg') }});">
                                </div>
                                <div class="overlay"></div>
                            </div>
                            <div class="text">
                                <h3><a href="product.php?id=99">Oculus Quest 2 - Advanced All-In-One Virtual Reality
                                        Headset</a></h3>
                                <h4>
                                    $495
                                    <del>
                        ...
                        <div class="item">
                            <div class="thumb">
                                <div class="photo"
                                    style="background-image:url({{ asset('frontend/assets/uploads/product-featured-98.jpg') }});">
                                </div>
                                <div class="overlay"></div>
                            </div>
                            <div class="text">
                                <h3><a href="product.php?id=98">Women's Fuzzy Fleece Lapel Open Front Long Cardigan
                                        Coat</a></h3>
                                <h4>
                                    $43
                                    <del>
                ...
                <div class="col-md-12">
                    <div class="product-carousel">
                        ...
                        <div class="item">
                            <div class="thumb">
                                <div class="photo"
                                    style="background-image:url({{ asset('frontend/assets/uploads/product-featured-92.jpg') }});">
                                </div>
                                <div class="overlay"></div>
                            </div>
                            <div class="text">
                        ...
                        <div class="item">
                            <div class="thumb">
                                <div class="photo"
                                    style="background-image:url({{ asset('frontend/assets/uploads/product-featured-94.jpg') }});">
                                </div>
                                <div class="overlay"></div>
                            </div>
                            <div class="text">
