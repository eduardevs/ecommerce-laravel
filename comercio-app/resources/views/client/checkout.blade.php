                    ...
                    <div class="cart">
                        <table class="table table-responsive table-hover table-bordered">
                            ...
                            <tr>
                                <td>1</td>
                                <td>
                                    <img src="{{ asset('frontend/assets/uploads/product-featured-95.jpg') }}"
                                        alt="">
                                </td>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="row">
                                ...
                                <form class="paypal" action="payment/paypal/payment_process.php" method="post"
                                    id="paypal_form" target="_blank">
                                ...
                                <form action="payment/bank/init.php" method="post" id="bank_form">
                                    ...
                                    <div class="col-md-12 form-group">
                                        <label for="">Transaction Information <br><span
                                                style="font-size:12px;font-weight:normal;">(Include transaction id and other
                                                information correctly)</span></label>
