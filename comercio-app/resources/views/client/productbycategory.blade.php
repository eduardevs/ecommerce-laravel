                        ...
                        <ul id="menu-group-1" class="nav menu">
                                ...
                                <ul class="children nav-child unstyled small collapse" id="cat-lvl1-id-1">
                                    ...
                                    <li class="deeper parent">
                                        <a class="" href="product-category.php?id=2&type=mid-category">
                                            <span data-toggle="collapse" data-parent="#menu-group-1" href="#cat-lvl2-id-12"
                                                class="sign"><i class="fa fa-plus"></i></span>
                                    ...
                                    <li class="deeper parent">
                                        <a class="" href="product-category.php?id=8&type=mid-category">
                                            <span data-toggle="collapse" data-parent="#menu-group-1"
                                                href="#cat-lvl2-id-13" class="sign"><i class="fa fa-plus"></i></span>
                                    ...
                                    <li class="deeper parent">
                                        <a class="" href="product-category.php?id=9&type=mid-category">
                                            <span data-toggle="collapse" data-parent="#menu-group-1"
                                                href="#cat-lvl2-id-14" class="sign"><i class="fa fa-plus"></i></span>
                            ...
                            <li class="cat-level-1 deeper parent">
                                <a class="" href="product-category.php?id=2&type=top-category">
                                    <span data-toggle="collapse" data-parent="#menu-group-1" href="#cat-lvl1-id-2"
                                        class="sign"><i class="fa fa-plus"></i></span>
                                ...
                                <ul class="children nav-child unstyled small collapse" id="cat-lvl1-id-2">
                                    <li class="deeper parent">
                                        <a class="" href="product-category.php?id=3&type=mid-category">
                                            <span data-toggle="collapse" data-parent="#menu-group-1"
                                                href="#cat-lvl2-id-21" class="sign"><i class="fa fa-plus"></i></span>
                                    ...
                                    <li class="deeper parent">
                                        <a class="" href="product-category.php?id=4&type=mid-category">
                                            <span data-toggle="collapse" data-parent="#menu-group-1"
                                                href="#cat-lvl2-id-22" class="sign"><i class="fa fa-plus"></i></span>
                                    ...
                                    <li class="deeper parent">
                                        <a class="" href="product-category.php?id=6&type=mid-category">
                                            <span data-toggle="collapse" data-parent="#menu-group-1"
                                                href="#cat-lvl2-id-23" class="sign"><i class="fa fa-plus"></i></span>
                                    ...
                                    <li class="deeper parent">
                                        <a class="" href="product-category.php?id=7&type=mid-category">
                                            <span data-toggle="collapse" data-parent="#menu-group-1"
                                                href="#cat-lvl2-id-24" class="sign"><i class="fa fa-plus"></i></span>
                            ...
                            <li class="cat-level-1 deeper parent">
                                <a class="" href="product-category.php?id=3&type=top-category">
                                    <span data-toggle="collapse" data-parent="#menu-group-1" href="#cat-lvl1-id-3"
                                        class="sign"><i class="fa fa-plus"></i></span>
                                ...
                                <ul class="children nav-child unstyled small collapse" id="cat-lvl1-id-3">
                                    <li class="deeper parent">
                                        <a class="" href="product-category.php?id=10&type=mid-category">
                                            <span data-toggle="collapse" data-parent="#menu-group-1"
                                                href="#cat-lvl2-id-31" class="sign"><i class="fa fa-plus"></i></span>
                                            <span class="lbl lbl1">Clothing</span>
                                        </a>
                                    ...
                                    <li class="deeper parent">
                                        <a class="" href="product-category.php?id=11&type=mid-category">
                                            <span data-toggle="collapse" data-parent="#menu-group-1"
                                                href="#cat-lvl2-id-32" class="sign"><i class="fa fa-plus"></i></span>
                                            <span class="lbl lbl1">Shoes</span>
                                        </a>
                                    ...
                                    <li class="deeper parent">
                                        <a class="" href="product-category.php?id=12&type=mid-category">
                                            <span data-toggle="collapse" data-parent="#menu-group-1"
                                                href="#cat-lvl2-id-33" class="sign"><i class="fa fa-plus"></i></span>
                                            <span class="lbl lbl1">Accessories</span>
                                        </a>
                            ...
                            <li class="cat-level-1 deeper parent">
                                <a class="" href="product-category.php?id=4&type=top-category">
                                    <span data-toggle="collapse" data-parent="#menu-group-1" href="#cat-lvl1-id-4"
                                        class="sign"><i class="fa fa-plus"></i></span>
                                ...
                                <ul class="children nav-child unstyled small collapse" id="cat-lvl1-id-4">
                                    <li class="deeper parent">
                                        <a class="" href="product-category.php?id=14&type=mid-category">
                                            <span data-toggle="collapse" data-parent="#menu-group-1"
                                                href="#cat-lvl2-id-41" class="sign"><i class="fa fa-plus"></i></span>
                                    ...
                                    <li class="deeper parent">
                                        <a class="" href="product-category.php?id=15&type=mid-category">
                                            <span data-toggle="collapse" data-parent="#menu-group-1"
                                                href="#cat-lvl2-id-42" class="sign"><i class="fa fa-plus"></i></span>
                            ...
                            <li class="cat-level-1 deeper parent">
                                <a class="" href="product-category.php?id=5&type=top-category">
                                    <span data-toggle="collapse" data-parent="#menu-group-1" href="#cat-lvl1-id-5"
                                        class="sign"><i class="fa fa-plus"></i></span>
                                ...
                                <ul class="children nav-child unstyled small collapse" id="cat-lvl1-id-5">
                                    <li class="deeper parent">
                                        <a class="" href="product-category.php?id=16&type=mid-category">
                                            <span data-toggle="collapse" data-parent="#menu-group-1"
                                                href="#cat-lvl2-id-51" class="sign"><i class="fa fa-plus"></i></span>
                                    ...
                                    <li class="deeper parent">
                                        <a class="" href="product-category.php?id=17&type=mid-category">
                                            <span data-toggle="collapse" data-parent="#menu-group-1"
                                                href="#cat-lvl2-id-52" class="sign"><i class="fa fa-plus"></i></span>
                        ...
                        <div class="row">
                            <div class="col-md-4 item item-product-cat">
                                <div class="inner">
                                    <div class="thumb">
                                        <div class="photo"
                                            style="background-image:url({{asset('frontend/assets/uploads/product-featured-86.jpg')}});"></div>
                                        <div class="overlay"></div>
                                    </div>
                                    <div class="text">
                                        <h3><a href="product.php?id=86">Amazfit GTS 3 Smart Watch for Android iPhone</a>
                                        </h3>
                                        <h4>
                                            $179
                                            <del>
                                        ...
                                        <p><a href="product.php?id=86"><i class="fa fa-shopping-cart"></i> Add to Cart</a>
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4 item item-product-cat">
                                <div class="inner">
                                    <div class="thumb">
                                        <div class="photo"
                                            style="background-image:url({{asset('frontend/assets/uploads/product-featured-85.jpg')}});"></div>
                                        <div class="overlay"></div>
                                    </div>
                                    <div class="text">
                                        ...
                                        <p><a href="product.php?id=85"><i class="fa fa-shopping-cart"></i> Add to Cart</a>
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4 item item-product-cat">
                                <div class="inner">
                                    <div class="thumb">
                                        <div class="photo"
                                            style="background-image:url({{asset('frontend/assets/uploads/product-featured-89.jpg')}});"></div>
                                        <div class="overlay"></div>
                                    </div>
                                    <div class="text">
                                        ...
                                        <p><a href="product.php?id=89"><i class="fa fa-shopping-cart"></i> Add to Cart</a>
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4 item item-product-cat">
                                <div class="inner">
                                    <div class="thumb">
                                        <div class="photo"
                                            style="background-image:url({{asset('frontend/assets/uploads/product-featured-100.jpg')}});"></div>
                                        <div class="overlay"></div>
                                    </div>
                                    <div class="text">
                                        ...
                                        <p><a href="product.php?id=100"><i class="fa fa-shopping-cart"></i> Add to
                                                Cart</a></p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4 item item-product-cat">
                                <div class="inner">
                                    <div class="thumb">
                                        <div class="photo"
                                            style="background-image:url({{asset('frontend/assets/uploads/product-featured-96.jpg')}});"></div>
                                        <div class="overlay"></div>
                                    </div>
                                    <div class="text">
                                        <h3><a href="product.php?id=96">Men's Loose Fit Heavyweight Long-Sleeve Pocket
                                                T-Shirt</a></h3>
                                        <h4>
                                            $23
                                            <del>
                                        ...
                                        <p><a href="product.php?id=96"><i class="fa fa-shopping-cart"></i> Add to Cart</a>
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4 item item-product-cat">
                                <div class="inner">
                                    <div class="thumb">
                                        <div class="photo"
                                            style="background-image:url({{asset('frontend/assets/uploads/product-featured-83.jpg')}});"></div>
                                        <div class="overlay"></div>
                                    </div>
                                    <div class="text">
                                        ...
                                        <p><a href="product.php?id=83"><i class="fa fa-shopping-cart"></i> Add to Cart</a>
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4 item item-product-cat">
                                <div class="inner">
                                    <div class="thumb">
                                        <div class="photo"
                                            style="background-image:url({{asset('frontend/assets/uploads/product-featured-88.jpg')}});"></div>
                                        <div class="overlay"></div>
                                    </div>
                                    <div class="text">
                                        <h3><a href="product.php?id=88">Under Armour Men's Sportstyle Left Chest Short
                                                Sleeve T-shirt</a></h3>
                                        <h4>
                                            $83
                                            <del>
                                        ...
                                        <p><a href="product.php?id=88"><i class="fa fa-shopping-cart"></i> Add to Cart</a>
                                        </p>
                                    </div>
                                </div>
                            </div>
