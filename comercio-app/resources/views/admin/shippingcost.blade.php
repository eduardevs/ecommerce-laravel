                        ...
                        <div class="box box-info">
                            <div class="box-body">
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Select Country
                                        <span>*</span></label>
                                    <div class="col-sm-4">
        ...
        <section class="content">
            <div class="row">
                <div class="col-md-12">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="#" class="btn btn-danger btn-xs"
                                                data-href="shipping-cost-delete.php?id=3" data-toggle="modal"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="#" class="btn btn-danger btn-xs"
                                                data-href="shipping-cost-delete.php?id=2" data-toggle="modal"
                                                data-target="#confirm-delete">Delete</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="#" class="btn btn-danger btn-xs"
                                                data-href="shipping-cost-delete.php?id=1" data-toggle="modal"
                                                data-target="#confirm-delete">Delete</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="#" class="btn btn-danger btn-xs"
                                                data-href="shipping-cost-delete.php?id=4" data-toggle="modal"
                                                data-target="#confirm-delete">Delete</a>
                                        </td>
                                    </tr>
                                </tbody>
                    ...
                    <h4 style="background: #dd4b39;color:#fff;padding:10px 20px;">NB: If a country does not exist in the
                        above list, the following "Rest of the World" shipping cost will be applied upon that.</h4>
        </section>
        <section class="content-header">
            <div class="content-header-left">
