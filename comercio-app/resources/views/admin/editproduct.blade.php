                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" name="p_name" class="form-control"
                                            value="Women's Plus-Size Shirt Dress with Gold Hardware">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4" style="padding-top:4px;">
                                        <img src="../assets/uploads/product-featured-102.jpg" alt=""
                                            style="width:150px;">
                                    ...
                                    <div class="col-sm-4" style="padding-top:4px;">
                                        <table id="ProductTable" style="width:100%;">
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <img src="../assets/uploads/product_photos/132.jpg" alt=""
                                                            style="width:150px;margin-bottom:5px;">
                                                    </td>
                                                    <td style="width:28px;">
                                                        <a onclick="return confirmDelete();"
                                                            href="product-other-photo-delete.php?id=132&id1=102"
