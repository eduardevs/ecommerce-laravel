  ...
  <aside class="main-sidebar">
      <section class="sidebar">
          <ul class="sidebar-menu">
              ...
              <li
                  class="treeview {{ request()->is('admin/size') || request()->is('admin/color') || request()->is('admin/country') || request()->is('admin/shippingcost') || request()->is('admin/toplevelcategory') || request()->is('admin/midlevelcategory') || request()->is('admin/endlevelcategory') ? 'active' : '' }}">
                  <a href="#">
                  ...
                  <ul class="treeview-menu">
                      ...
                      <li><a href="{{ url('/admin/shippingcost') }}"><i class="fa fa-circle-o"></i> Shipping Cost</a>
                      </li>
                      <li><a href="{{ url('/admin/toplevelcategory') }}"><i class="fa fa-circle-o"></i> Top Level
                              Category</a></li>
                      <li><a href="{{ url('/admin/midlevelcategory') }}"><i class="fa fa-circle-o"></i> Mid Level
                              Category</a></li>
                      <li><a href="{{ url('/admin/endlevelcategory') }}"><i class="fa fa-circle-o"></i> End Level
                              Category</a></li>
                  </ul>
              </li>
